...
public class ResumeParserProgram {
  public File parseToHTMLUsingApacheTikka(String file)
  ...
  public JSONObject loadGateAndAnnie(File file) throws GateException, IOException {
    ...
    if (iter.hasNext()) {
      ...
      String[] annSections =
          new String[] {"EmailFinder", "AddressFinder", "PhoneFinder", "URLFinder"};
      ...
      while (it.hasNext()) {
        ...
        if (key.equals("work_experience_marker")) {
          ...
          String[] annotations =
              new String[] {"date_start", "date_end", "jobtitle", "organization"};
